...
public class DeathState extends GameState {
	...
	public void init() {
		...
		playSound("/Music/level1-1.mp3");

		//bgMusic = new AudioPlayer("C:/Users/aeuna/eclipse-workspace/OOP_Java_Project/bin/Music/bgm_001.m4a");
		//bgMusic.play();
		//bgMusic.doPlay("/Music/level1-1.mp3");
	...
	public void draw(Graphics2D g) {
		...
		titleColor = new Color((colorFactor*10)%255,colorFactor,colorFactor);
		drawCube(g, 160, 115, 150, 150, 330, 0.3, titleColor);
		
		// draw title
		g.setColor(Color.BLACK);
		g.setFont(titleFont);
		g.drawString("YOU HAVE BEEN DIED", 18, 71);
		g.setColor(titleColor);
		g.drawString("YOU HAVE BEEN DIED", 19, 70);
